# Requirements Archive: v1.0 German Data Completeness
...
- [x] **VERB-01**: All 148 German verbs in `verbbank.json` have `conjugations.preteritum.former` with all 6 pronoun forms (ich/du/er-sie-es/wir/ihr/sie-Sie)
- [x] **VERB-02**: Preteritum data is linguistically correct German (strong/weak/irregular verbs handled correctly)
...
| VERB-01 | Phase 2 | Complete |
| VERB-02 | Phase 2 | Complete |
...
*Last updated: 2026-02-20 — archived after v1.0 milestone completion (all 5 requirements satisfied)*
